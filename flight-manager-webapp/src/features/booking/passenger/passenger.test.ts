...
it('should add just one error for first name', () => {
    const passenger = new Passenger("1", 'MR', 'MALE', 'Someone Else', 'Calisto', '1988-08-20')
    passenger.setFirstName('Nomeone Else')
    passenger.setFirstName('Nameone Else')
    passenger.setFirstName('Nateone Else')
    passenger.setFirstName('Nataone Else')
    passenger.setFirstName('Natalne Else')
    passenger.setFirstName('Natalie Else')
    passenger.setFirstName('Natalia Else')
    passenger.setFirstName('Natalia Alse')
    passenger.setFirstName('Natalia Amse')
    passenger.setFirstName('Natalia Amee')
    passenger.setFirstName('Natalia Amel')
    passenger.setFirstName('Natalia Ameli')
    passenger.setFirstName('Natalia Amelia')

    expect(passenger.getErrors().length).toBe(1)
    expect(passenger.getErrors()[0]).toBe('Maximum a change of 3 digits for first name is allowed')
})

it('should add just one error for last name', () => {
    const passenger = new Passenger("1", 'MR', 'MALE', 'Caio', 'Frttruwq', '1988-08-20')
    passenger.setLastName('Frttruwq')
    passenger.setLastName('Fettruwq')
    passenger.setLastName('Fertruwq')
    passenger.setLastName('Ferrruwq')
    passenger.setLastName('Ferrruwq')
    passenger.setLastName('Ferreuwq')
    passenger.setLastName('Ferreiwq')
    passenger.setLastName('Ferreirq')
    passenger.setLastName('Ferreira')
